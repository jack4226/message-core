...
public class Hash32 implements java.io.Serializable {
	private static final long serialVersionUID = 210364466019560706L;

	// / How big a hash is.
	protected int hashSize = 4;

	// / The hash bytes.
	protected byte[] hashBytes = new byte[hashSize];
	...
	/**
	 * utility routine for hashing a String in one step Call like so:
	 * <BLOCKQUOTE> byte[] hash = new Hash32().hashStr( str, new SomeHash() );
	 * </BLOCKQUOTE>
	 */
	public byte[] hashStr(String str, Hash32 hash) {
		add(str);
		return get();
	}
	...
	private int crc32Tab[] = { 0x0, 0x04c11db7, 0x09823b6e, 0x0d4326d9,
