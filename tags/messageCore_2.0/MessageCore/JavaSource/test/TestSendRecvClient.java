 ...
 */
public class TestSendRecvClient {
	static Logger log;
	...
	public static void main(String args[]) throws Exception {
		ChapterExRepository.init(TestSendRecvClient.class);
		log = Logger.getLogger("TestSendRecvClient");

		log.info("Begin SendRecvClient, now=" + System.currentTimeMillis());
		TestSendRecvClient client = new TestSendRecvClient();
