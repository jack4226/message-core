...
public class TabbedPaneRenderer extends Renderer {
	...
	// listeners in the Invoke Application phase of the JSF life cycle. Action
	// listeners can be specified with the <msgui:tabbedpane>'s actionListener
	// attribute or with <f:actionListener> tags in the body of the
	// <msgui:tabbedpane> tag.
	...
	// with the CSS class specified by the <msgui:tabbedpane>'s styleClass
	...
	// encodeBegin().
	// The children of the <msgui:tabbedpane> component are UISelectItem
	// components, set with one or more <f:selectItem> tags or a single
	// <f:selectItems> tag in the body of <msgui:tabbedpane>
	...
	private void encodeHiddenField(FacesContext context, ResponseWriter writer, UIComponent component)
	...
	private void encodeTab(FacesContext context, ResponseWriter writer, SelectItem item, UIComponent component)
			throws java.io.IOException {
		...
		writer.writeAttribute("onclick",
				// write value for hidden field whose name is the tabbedpane's
				// client Id
	...
	// <msgui:tabbedpane>'s resourceBundle attribute. If no value is found,
