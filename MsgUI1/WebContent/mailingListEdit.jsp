<html>
   ...
   <f:view>
      <head>
         ...
         <title><h:outputText value="#{msgs.editMailingListPageTitle}"/></title>
      </head>

      <body onLoad="document.getElementById('mlstedit:content:listid').focus();">
      <div align="center">
         <h:form id="mlstedit">
            <h:panelGrid columns="1" styleClass="headerMenuContent"
			   ...
			   <f:subview id="content">
               	<c:import url="/includes/mailingListEdit.jsp"/>
               </f:subview>
               <f:subview id="footer">
