<html>
   ...
   <f:view>
      <head>
         ...
         <title><h:outputText value="#{msgs.editSiteUserPageTitle}"/></title>
      </head>

      <body onLoad="document.getElementById('useracct:content:firstname').focus();">
      <div align="center">
         <h:form id="useracct">
            <h:panelGrid columns="1" styleClass="headerMenuContent"
			   ...
			   <f:subview id="content">
               	<c:import url="/includes/userAccountEdit.jsp"/>
               </f:subview>
               <f:subview id="footer">
