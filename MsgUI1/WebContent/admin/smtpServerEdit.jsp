<html>
   ...
   <f:view>
      <head>
         ...
         <title><h:outputText value="#{msgs.editSmtpServerPageTitle}"/></title>
      </head>

      <body onLoad="document.getElementById('smtpedit:content:smtphost').focus();">
      <div align="center">
         <h:form id="smtpedit">
            <h:panelGrid columns="1" styleClass="headerMenuContent"
			   ...
			   <f:subview id="content">
               	<c:import url="/includes/smtpServerEdit.jsp"/>
               </f:subview>
               <f:subview id="footer">
