...
public class ActionDetailsTest extends AbstractLogin {
	static final Logger logger = LogManager.getLogger(ActionDetailsTest.class);
	...
	public void testActionDetails() {
		...
		try {
			...
			WebElement actionNameElm = driver.findElement(By.id("actdtledt:content:actionid"));
			...
			WebElement actionDescElm = driver.findElement(By.id("actdtledt:content:description"));
			...
			WebElement beanIdElm = driver.findElement(By.id("actdtledt:content:beanid"));
			assertNotNull(beanIdElm);
			assertEquals("assignRuleNameBo", beanIdElm.getAttribute("value"));
 			
			Select selectDataType = new Select(driver.findElement(By.id("actdtledt:content:datatype")));
			...
			WebElement submit = driver.findElement(By.id("actdtledt:content:submit"));
