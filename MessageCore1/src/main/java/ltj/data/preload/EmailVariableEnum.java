...
public enum EmailVariableEnum implements EnumInterface {
	...
	CustomerName(EmailVariableType.Custom, "customers", "FirstName,LastName", false, "Valued Customer",
			"SELECT CONCAT(c.FirstName, ' ', c.LastName) as ResultStr FROM customers c, emailaddr e where e.emailaddrId=c.emailAddrId and e.emailAddrId=?;","ltj.message.external.CustomerNameResolver"),
	CustomerFirstName(EmailVariableType.Custom, "customers", "FirstName", false, "Valued Customer",
			"SELECT c.FirstName as ResultStr FROM customers c, emailaddr e where e.emailaddrId=c.emailAddrId and e.emailAddrId=?;","ltj.message.external.CustomerNameResolver"),
	CustomerLastName(EmailVariableType.Custom, "customers", "LastName", false, "Valued Customer",
			"SELECT c.LastName as ResultStr FROM customers c, emailaddr e where e.emailaddrId=c.emailAddrId and e.emailAddrId=?;","ltj.message.external.CustomerNameResolver"),
	CustomerAddress(EmailVariableType.Custom, "customers", "StreetAddress", false, "",
			"SELECT CONCAT_WS(',',c.StreetAddress2,c.StreetAddress) as ResultStr FROM customers c, emailaddr e where e.emailaddrId=c.emailAddrId and e.emailAddrId=?;","ltj.message.external.CustomerNameResolver"),
	CustomerCityName(EmailVariableType.Custom, "customers", "CityName", false, "",
			"SELECT c.CityName as ResultStr FROM customers c, emailaddr e where e.emailaddrId=c.emailAddrId and e.emailAddrId=?;","ltj.message.external.CustomerNameResolver"),
	CustomerStateCode(EmailVariableType.Custom, "customers", "StateCode", false, "",
			"SELECT CONCAT_WS(',',c.StateCode,c.ProvinceName) as ResultStr FROM customers c, emailaddr e where e.emailaddrId=c.emailAddrId and e.emailAddrId=?;","ltj.message.external.CustomerNameResolver"),
	CustomerZipCode(EmailVariableType.Custom, "customers", "ZipCode", false, "",
			"SELECT CONCAT_WS('-',c.ZipCode5,c.ZipCode4) as ResultStr FROM customers c, emailaddr e where e.emailaddrId=c.emailAddrId and e.emailAddrId=?;","ltj.message.external.CustomerNameResolver"),
	CustomerCountry(EmailVariableType.Custom, "customers", "Country", false, "",
			"SELECT c.Country as ResultStr FROM customers c, emailaddr e where e.emailaddrId=c.emailAddrId and e.emailAddrId=?;","ltj.message.external.CustomerNameResolver"),
