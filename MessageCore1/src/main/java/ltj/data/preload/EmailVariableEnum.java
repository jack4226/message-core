...
public enum EmailVariableEnum implements EnumInterface {
	...
	CustomerName(EmailVariableType.Custom, "customer_tbl", "FirstName,LastName", false, "Valued Customer",
			"SELECT CONCAT(c.first_name, ' ', c.last_name) as ResultStr FROM customer_tbl c, email_address e where e.email_addr_id=c.email_addr_id and e.email_addr_id=?;","ltj.message.external.CustomerNameResolver"),
	CustomerFirstName(EmailVariableType.Custom, "customer_tbl", "FirstName", false, "Valued Customer",
			"SELECT c.first_name as ResultStr FROM customer_tbl c, email_address e where e.email_addr_id=c.email_addr_id and e.email_addr_id=?;","ltj.message.external.CustomerNameResolver"),
	CustomerLastName(EmailVariableType.Custom, "customer_tbl", "LastName", false, "Valued Customer",
			"SELECT c.last_name as ResultStr FROM customer_tbl c, email_address e where e.email_addr_id=c.email_addr_id and e.email_addr_id=?;","ltj.message.external.CustomerNameResolver"),
	CustomerAddress(EmailVariableType.Custom, "customer_tbl", "StreetAddress", false, "",
			"SELECT CONCAT_WS(',',c.street_address2,c.street_address) as ResultStr FROM customer_tbl c, email_address e where e.email_addr_id=c.email_addr_id and e.email_addr_id=?;","ltj.message.external.CustomerNameResolver"),
	CustomerCityName(EmailVariableType.Custom, "customer_tbl", "CityName", false, "",
			"SELECT c.city_name as ResultStr FROM customer_tbl c, email_address e where e.email_addr_id=c.email_addr_id and e.email_addr_id=?;","ltj.message.external.CustomerNameResolver"),
	CustomerStateCode(EmailVariableType.Custom, "customer_tbl", "StateCode", false, "",
			"SELECT CONCAT_WS(',',c.state_code,c.province_name) as ResultStr FROM customer_tbl c, email_address e where e.email_addr_id=c.email_addr_id and e.email_addr_id=?;","ltj.message.external.CustomerNameResolver"),
	CustomerZipCode(EmailVariableType.Custom, "customer_tbl", "ZipCode", false, "",
			"SELECT CONCAT_WS('-',c.zip_code5,c.zip_code4) as ResultStr FROM customer_tbl c, email_address e where e.email_addr_id=c.email_addr_id and e.email_addr_id=?;","ltj.message.external.CustomerNameResolver"),
	CustomerCountry(EmailVariableType.Custom, "customer_tbl", "Country", false, "",
			"SELECT c.country as ResultStr FROM customer_tbl c, email_address e where e.email_addr_id=c.email_addr_id and e.email_addr_id=?;","ltj.message.external.CustomerNameResolver"),
