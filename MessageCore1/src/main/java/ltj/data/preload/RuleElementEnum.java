...
public enum RuleElementEnum {
	...
	OUF_OF_OFFICE_AUTO_REPLY_1(RuleNameEnum.OutOfOffice_AutoReply, 1, RuleDataName.SUBJECT, null, RuleCriteria.REG_EX, false,
			"(?:out\\s+of\\s+.*office|\\(away from the office\\)$)", null,
			null, null, null),
	OUF_OF_OFFICE_AUTO_REPLY_2(RuleNameEnum.OutOfOffice_AutoReply, 2, RuleDataName.BODY, null, RuleCriteria.REG_EX, false,
	...
	SPAM_SCORE_1(RuleNameEnum.XHeader_SpamScore, 1, RuleDataName.X_HEADER, XHeaderName.SPAM_SCORE, RuleCriteria.GREATER_THAN, false,
			"100", null,
			null, null, null),
	...
	HARD_BOUNCE_NO_FINAL_RCPT_2(RuleNameEnum.HardBounce_NoFinalRcpt, 2, RuleDataName.FINAL_RCPT_ADDR, null, RuleCriteria.IS_BLANK, false,
			"", null,
			null, null, null),
	HARD_BOUNCE_NO_FINAL_RCPT_3(RuleNameEnum.HardBounce_NoFinalRcpt, 3, RuleDataName.ORIG_RCPT_ADDR, null, RuleCriteria.IS_BLANK, false,
			"", null,
			null, null, null),
