...
public enum RuleActionEnum {
	...
	SIZE_TOO_LARGE_1(RuleNameEnum.MSGSIZE_TOO_BIG, 1, RuleActionDetailEnum.SAVE, null),
	SIZE_TOO_LARGE_2(RuleNameEnum.MSGSIZE_TOO_BIG, 2, RuleActionDetailEnum.TO_CSR, "$" + QueueNameEnum.CUSTOMER_CARE_INPUT.name()),
	...
	RMA_REQUEST_3(RuleNameEnum.RMA_REQUEST, 3, RuleActionDetailEnum.TO_CSR, "$" + TableColumnName.RMA_DEPT_ADDR),
	...
	GENERIC_3(RuleNameEnum.GENERIC, 3, RuleActionDetailEnum.TO_CSR, "$" + QueueNameEnum.CUSTOMER_CARE_INPUT.name()),
	...
	OUF_OF_OFFICE_AUTO_REPLY_1(RuleNameEnum.OutOfOffice_AutoReply, 1, RuleActionDetailEnum.SAVE, null),
	OUF_OF_OFFICE_AUTO_REPLY_2(RuleNameEnum.OutOfOffice_AutoReply, 2, RuleActionDetailEnum.CLOSE, null),
	CONTACT_US_1(RuleNameEnum.Contact_Us, 1, RuleActionDetailEnum.SAVE, null),
	SPAM_SCORE_1(RuleNameEnum.XHeader_SpamScore, 1, RuleActionDetailEnum.SAVE, null),
	SPAM_SCORE_2(RuleNameEnum.XHeader_SpamScore, 2, RuleActionDetailEnum.CLOSE, null),
	EXECUTABLE_ATTACHMENT_1(RuleNameEnum.Executable_Attachment, 1, RuleActionDetailEnum.DROP, null),
	HARD_BOUNCE_WATCHED_MAILBOX_1(RuleNameEnum.HardBouce_WatchedMailbox, 1, RuleActionDetailEnum.SAVE, null),
	HARD_BOUNCE_WATCHED_MAILBOX_2(RuleNameEnum.HardBouce_WatchedMailbox, 2, RuleActionDetailEnum.OPEN, null),
	HARD_BOUNCE_NO_FINAL_RCPT_1(RuleNameEnum.HardBounce_NoFinalRcpt, 1, RuleActionDetailEnum.SAVE, null),
	HARD_BOUNCE_NO_FINAL_RCPT_2(RuleNameEnum.HardBounce_NoFinalRcpt, 2, RuleActionDetailEnum.OPEN, null);
