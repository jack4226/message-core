...
public class ActionTables extends CreateTableBase {
	...
	void createActionDetailTable() throws SQLException {
		try {
			...
			"FOREIGN KEY msg_action_detail_fk_data_type (data_type) REFERENCES msg_data_type (data_type) ON DELETE CASCADE ON UPDATE CASCADE, " +
	...
	void createActionTable() throws SQLException {
		try {
			...
			"FOREIGN KEY msg_action_fk_rule_name (rule_name) REFERENCES rule_logic (rule_name) ON DELETE CASCADE ON UPDATE CASCADE, " +
			"INDEX msg_action_ix_rule_name (rule_name), " +
			"FOREIGN KEY msg_action_fk_action_id (action_id) REFERENCES msg_action_detail (action_id) ON DELETE CASCADE ON UPDATE CASCADE, " +
