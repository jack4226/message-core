...
public class LoadActionTables {
	...
	void load(MsgActionDao msgActionDao) {
		...
		msgActionDao.insert(act);
		act = new MsgActionVo(RuleNameType.SOFT_BOUNCE.toString(),2,now,null,"BOUNCE++","A","$"+AddressType.FINAL_RCPT_ADDR.value()+","+"$"+AddressType.ORIG_RCPT_ADDR.value());
		msgActionDao.insert(act);
		...
		msgActionDao.insert(act);
		act = new MsgActionVo(RuleNameType.MAILBOX_FULL.toString(),2,now,null,"BOUNCE++","A","$"+AddressType.FINAL_RCPT_ADDR.value()+","+"$"+AddressType.ORIG_RCPT_ADDR.value());
		msgActionDao.insert(act);
