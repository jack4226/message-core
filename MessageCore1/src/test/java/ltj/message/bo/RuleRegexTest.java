...
public class RuleRegexTest {
	...
	@Test
	public void challenge_response() {
		...
		assertEquals("challenge_response body matching? ", true, matcher.find());
		...
		assertEquals("challenge_response header matching? ", true, matcher.find());
		...
		assertEquals("challenge_response subject matching? ", true, matcher.find());
		...
		assertEquals("challenge_response from matching? ", true, matcher.find());
	}
	...
	public void postmaster() {
		...
		assertEquals("postmater matching: ", true, m.find());
	...
	public void outOfOffice() {
		...
		assertEquals("Out of office matching: ", true, m.find());
		m.reset("out of the office auto reply");
		assertEquals(true, m.find());
	}
	
	@Test
	public void auto_reply() {
		...
		assertEquals("Auto-reply matching: ", true, m.find());
	...
	public void deliveryFailure() {
		...
		assertEquals("Delivery Failure matching: ", true, m.find());
	...
	public void spamblocker() {
		...
		assertEquals("Spam blocker matching: ", true, m.find());
	...
	public void virusBlocker() {
		...
		assertEquals("Virus blocker matching", true, m.find());
